...
def fun_get_data_from_api(**kwargs):
    ...
    # insert to mysql #Sekalian create table covid_jabar di mySQL
    data.to_sql(con=engine_sql,name='covid_jabar', index=False)
    logging.info("SUCCESS INSERT TO MYSQL")
...
# Define the task dependencies
    op_get_data_from_api >> op_generate_dim >> op_insert_province_daily >> op_insert_district_daily